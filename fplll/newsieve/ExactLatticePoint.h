...
{
  unsigned int first_level = static_cast<std::size_t>(this->do_compute_sc_product_bitapprox_level(another, lvl));
  unsigned int cross_prod1 = static_cast<std::size_t>( SimHash::sim_hash_len - (this->fixed_bitapprox_data_level[lvl] ^ another.fixed_bitapprox_data_layer[lvl]).count() );
  unsigned int cross_prod2 = static_cast<std::size_t>( SimHash::sim_hash_len - (this->fixed_bitapprox_data_layer[lvl] ^ another.fixed_bitapprox_data_level[lvl]).count() );
  unsigned int cross_prod3 = static_cast<std::size_t>( SimHash::sim_hash_len - (this->fixed_bitapprox_data_layer[lvl] ^ another.fixed_bitapprox_data_layer[lvl]).count() );
  // return (0*first_level+cross_prod1+cross_prod2);
  return cross_prod3;
}
*/
//#endif
