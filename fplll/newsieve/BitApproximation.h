...
unsigned int constexpr num_of_transforms = 6; //per 1 approximation (to get dim-dimensional binary vector)
...
-> std::vector<T>
{
//  double constexpr sqrt2   = 1.41421356237309504880168872421L;
  ...
  const double lengthfactor = std::sqrt(len);
