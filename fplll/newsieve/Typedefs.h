...
//#endif
  ...
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_2sieve_lb = {{32-0, 64-0}};
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_2sieve_ub = {{32+0, 64+0}};

  //for 3-sieve: outer loop
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_3sieve_lb_out = {{32-0, 64-0}};
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_3sieve_ub_out = {{32+0, 64+0}};

  //for 3-sieve: outer loop
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_3sieve_lb_inn = {{32-0, 64-0}};
  constexpr static std::array<unsigned int, sim_hash_num> threshold_lvls_3sieve_ub_inn = {{32+0, 64+0}};
